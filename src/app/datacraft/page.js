...
const Page = () => {
    ...
    return (
        <>
    <main className="flex flex-col w-full items-center bg-black100 pt-[50px] md:pt-[100px] relative">
        <div className="wrapper p-3 md:p-[0px]">    
        <div className="flex flex-row justify-between pb-[50px]">
            <div className="flex flex-col items-start w-[802px]">
            <a href="https://datacraft.store/"><h1 className="text-center text-5xl md:text-[86px] leading-tight text-green200 cursor-scale">DATACRAFT.STORE</h1></a>
            <p className="text-lg md:text-xl text-green200 font-[400] text-justify leading-tight"><span className="italic text-greenAccent">Project description:</span> The project involves transferring a design from Figma to WordPress without using child themes or page builders. This includes developing a custom theme to accurately reflect all design details and elements, ensuring the site is fully responsive for mobile devices. The process focuses on maintaining design integrity, optimizing performance, and ensuring cross-browser compatibility for an exceptional user experience.</p></div>
            <div className="hidden lg:block pt-[15px]"><p className="text-xl text-green200">2024</p></div>
            <div className="hidden lg:flex flex-col gap-6 pt-[15px]">
